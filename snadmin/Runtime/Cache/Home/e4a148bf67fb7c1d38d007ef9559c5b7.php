...
@font-face {
    ...
    <div class="formtitle"><span>自动匹配配置</span></div>
      <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/onekey_set">
    <ul class="forminfo">
	...
	<div class="formtitle"><span>手动一键</span></div>
      <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/onekey_match">
